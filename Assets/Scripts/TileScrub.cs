...
public class TileScrub : MonoBehaviour
{
    ...
    void gon(float olo)
    {
        ...
        tilemap.SetTile(tilePos, null);        
        tilePos = tilemap.WorldToCell(new Vector3((olo + 2), -1, 0));
        tilemap.SetTile(tilePos, null);   
        tilePos = tilemap.WorldToCell(new Vector3((olo + 2), -2, 0));
        tilemap.SetTile(tilePos, null);
        tilePos = tilemap.WorldToCell(new Vector3((olo + 2), -3, 0));
        tilemap.SetTile(tilePos, null);
        tilePos = tilemap.WorldToCell(new Vector3((olo + 2), -4, 0));
        tilemap.SetTile(tilePos, null);   
        tilePos = tilemap.WorldToCell(new Vector3((olo + 2), -5, 0));
        tilemap.SetTile(tilePos, null);
        tilePos = tilemap.WorldToCell(new Vector3((olo - 1), -1, 0));
        tilemap.SetTile(tilePos, null);    
        tilePos = tilemap.WorldToCell(new Vector3((olo - 1), -2, 0));
